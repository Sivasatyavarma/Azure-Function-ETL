...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        abs_acct_name='stcloudetldemodatatest'
        abs_acct_url=f'https://{abs_acct_name}.blob.core.windows.net/'
        abs_container_name='demo-cloudetl-data-test'
        archive_container_name = 'demo-cloudetl-archive-test'

        adls_acct_name='dlscloudetldemotest'
        adls_acct_url = f'https://{adls_acct_name}.dfs.core.windows.net/'
        adls_fsys_name='processed-data-demo-test'
        adls_dir_name='finance_data-data'
